...
const announcement = {
  title: '最新公告',
  content: '得益于雨云对本ETS2LA国内镜像站的赞助，目前可视化内容左侧的内部地图已切换至雨云赞助的服务器上，由于是赞助，所以是有考核要求的：目前我需要通过我的推广链接每月卖出2台总共155元的服务器，如果考核任务未完成雨云将收回服务器，届时可视化仍将切换回原服务器并保留3M的限速；如果您确实有需求，欢迎点击网站中的雨云图片注册账号并购买服务器。如果您仍然希望获得更快的访问速度请为 ETS2LA国内镜像站提供者 晚安（QQ：1804832964） 进行赞助（请备注赞助目的、所在省份以及联系方式），晚安将会单独从阿里云给你开一台机器（电信/联通/移动三线峰值 200mbps= 25MB/s）并使用特定域名供你访问。',
  date: '2026-04-10',
}
